...
const (
	...
	// ApplicationRestoreReplacePolicyFail is to specify that the restore
	// should fail if there are existing resources that conflict with resources being
	// restored
	ApplicationRestoreReplacePolicyFail ApplicationRestoreReplacePolicyType = "Fail"
)
